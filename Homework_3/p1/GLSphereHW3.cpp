...
GLSphereHW3::GLSphereHW3(float center_x, float center_y, float center_z, float radius, int rows, int segments )
{
 ...
 */
void GLSphereHW3::initShader(void)
{
#ifdef _WIN32
    // This loads the shader program from a file
    _program = LoadAndCreateShaderProgram("HW3.vs", "HW3.fs");
#else
	// This loads the shader program from a file
    _program = LoadAndCreateShaderProgram("../HW3.vs", "../HW3.fs");
#endif
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////////
    // Material
    _material._diffuse_material = glm::vec3(0.0, 0.05, 1.0);
    _material._ambient_material = glm::vec3(0.0, 0.05, 1.0);
    _material._specular_material = glm::vec3(0.0, 0.05, 1.0);
    ...
    // material 2
    _material2._diffuse_material = glm::vec3(0.0, 0.05, 1.0);
    _material2._ambient_material = glm::vec3(0.0, 0.05, 1.0);
    _material2._specular_material = glm::vec3(0.0, 0.05, 1.0);
    _material2._shininess = 1.0;
    ...
    _light_source2._lightPos = glm::vec4(20.0, 20.0, 0.0, 1.0);
    _light_source2._ambient_intensity = 0.3;
    _light_source2._specular_intensity = 5.0;
    _light_source2._diffuse_intensity = 2.0;
    _light_source2._attenuation_coeff = 0.02;
    
    _light_source2._cone_angle = 1.0; // in degree
