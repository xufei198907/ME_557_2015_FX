...
GLSphereDiff::GLSphereDiff(float center_x, float center_y, float center_z, float radius, int rows, int segments )
{
 ...
 */
void GLSphereDiff::initShader(void)
{
#ifdef _WIN32
...
#else
	 // This loads the shader program from a file
    _program = LoadAndCreateShaderProgram("../directlight.vs", "../directlight.fs");
#endif
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////////
    // Material
    _material._diffuse_material = glm::vec3(0.0, 0.0, 0.25);
    _material._ambient_material = glm::vec3(0.0, 0.0, 0.25);
    _material._specular_material = glm::vec3(0.0, 0.0, 0.25);
    ...
    _light_source1._lightPos = glm::vec4(10.0,10.0,10.0,0.0);
