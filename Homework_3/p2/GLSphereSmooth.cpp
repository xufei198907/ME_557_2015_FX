...
GLSphereSmooth::GLSphereSmooth(float center_x, float center_y, float center_z, float radius, int rows, int segments )
{
 ...
 */
void GLSphereSmooth::initShader(void)
{
#ifdef _WIN32
...
#else
    // This loads the shader program from a file
    _program = LoadAndCreateShaderProgram("../HW3_p2_sphere4.vs", "../HW3_p2_sphere4.fs");
#endif
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////////
    // Material
    _material._diffuse_material = glm::vec3(1.0, 0.9, 0.0);
    _material._ambient_material = glm::vec3(1.0, 0.9, 0.0);
    _material._specular_material = glm::vec3(1.0, 0.9, 0.0);
    ...
    _light_source1._lightPos = glm::vec4(75.0,40.0,4.0,1.0);
    _light_source1._ambient_intensity = 0.2;
    _light_source1._specular_intensity = 0.0;
    _light_source1._diffuse_intensity = 100.0;
    _light_source1._attenuation_coeff = 0.05;
    _light_source1._cone_angle = 90.0; // in degree
    _light_source1._cone_direction = glm::vec3(0, -1.0, -1.0); // this must be aligned with the object and light position.
    
    
    _light_source2._lightPos = glm::vec4(75.0,6.0,10.0,1.0);
    _light_source2._ambient_intensity = 0.01;
    _light_source2._specular_intensity = 1.0;
    _light_source2._diffuse_intensity = 1.0;
    _light_source2._attenuation_coeff = 0.02;
    _light_source2._cone_angle = 70.0; // in degree
