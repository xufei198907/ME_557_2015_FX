...
GLSphereHlgtDiff::GLSphereHlgtDiff(float center_x, float center_y, float center_z, float radius, int rows, int segments )
{
...
GLSphereHlgtDiff::~GLSphereHlgtDiff()
{
 ...
 */
void GLSphereHlgtDiff::initShader(void)
{
#ifdef _WIN32
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////////
    // Material
    _material._diffuse_material = glm::vec3(0.7, 0.0, 0.0);
    _material._ambient_material = glm::vec3(0.7, 0.0, 0.0);
    ...
    _light_source1._lightPos = glm::vec4(7.5,2.0,8.0,1.0);
    _light_source1._ambient_intensity = 0.3;
    _light_source1._specular_intensity = 5.0;
    _light_source1._diffuse_intensity = 0.1;
    _light_source1._attenuation_coeff = 0.02;
    
    _light_source1._cone_angle = 90.0; // in degree
    _light_source1._cone_direction = glm::vec3(-1.0, 0.0, -1.0); // this must be aligned with the object and light position.
