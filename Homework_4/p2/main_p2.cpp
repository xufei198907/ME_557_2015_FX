...
int main(int argc, const char * argv[])
{
    ...
    GLAppearance* apperance_0 = new GLAppearance("../color_noise.vs", "../color_noise.fs");
    ...
    int texid = texture->loadAndCreateTextures("../../data/landscape_1.bmp", "../../data/noisemap_2.bmp");
    ...
    SetViewAsLookAt(glm::vec3(0.0f, 0.0f, 65.5f), glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(0.0f, 1.0f, 0.0f));
